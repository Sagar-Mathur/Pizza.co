    ...
    return(
        <div className="product-burgur-list">
            ...
            {Productname.map((product, index) => (
              ...
              <img className='burgur-product-image' src={ drinkimg[index]}/>
              <br></br>
...
export default connect(null,{addToCart})(Drink);